...
public class Withdraw extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nonce=request.getParameter("nonce"); //GET NONCE VALUE FROM SUBMITTED FORM
        
        HttpSession session = request.getSession(false); //DON'T CREATE NEW SESSION
        boolean idMatches=false;
        boolean nonceMatches=false;

        //First try to find JSESSIONID cookie value
        ...
        //If session ID matches and amount is given then withdraw funds
        if (idMatches==true && nonceMatches==true && amount!=null)
        {
            ...
            session.setAttribute("balance", new Float(currentBalance));
